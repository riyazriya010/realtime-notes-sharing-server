...
class JwtService {
    ...
    createAccessToken(id, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const syncToken = yield jsonwebtoken_1.default.sign({ id, email }, String(constant_1.JWT_SECRET), { expiresIn: '2h' });
                return syncToken;
            }
            catch (error) {
    ...
    createRefreshToken(id, email) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const syncToken = yield jsonwebtoken_1.default.sign({ id, email }, String(constant_1.JWT_SECRET), { expiresIn: '7d' });
                return syncToken;
            }
            catch (error) {
                if (error instanceof jsonwebtoken_1.JsonWebTokenError) {
